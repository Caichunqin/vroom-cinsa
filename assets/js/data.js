export default {
  ...
  about: {
    introduction: [
      '广东省计算机信息网络安全协会(下称协会）成立于1999年7月，是全国首家信息网络安全专业协会，由广东省公安厅主管、省公安厅网络警察总队直接指导、在广东省民政厅登记注册的社会团体，属非营利性专业协会。在社会各界的鼎力支持下，目前会员遍及IT行业、行政机关、银行、电信、教育、电力、交通、医疗卫生等各个领域。',
